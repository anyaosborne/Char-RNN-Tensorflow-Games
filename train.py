...
parser.add_argument('--data_dir', type=str, default='data/games',
...
parser.add_argument('--output_rate', type=float, default=1.0,
                    help='probability of keeping weights in the hidden layer')
parser.add_argument('--input_rate', type=float, default=1.0,
